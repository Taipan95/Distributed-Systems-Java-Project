...
public class Server {
    ...
    private static final int m = 765; //m is number of all USERS (Y axis)
    private static final int n = 1965; //n is number of all POIs (X axis)
    ...
    private ArrayList<ClientActions> clientActions = new ArrayList<>();
...
*/
        ...
        System.out.println("Minimum amount of workers: ");
    ...
    private void initialize() throws FileNotFoundException {
        ...
        R = readFile(new FileInputStream("input.csv"));
    ...
    private double calculateError() {
        ...
        System.out.println("Costs function's first term is: "+Left);
        System.out.println("Costs function's second term (normalization) is: "+Right);
        return (Left + Right);

    }

    private void sortWorkers() {
        Collections.sort(workerActions, new Comparator<WorkerActions>() {
            @Override
            public int compare(WorkerActions o1, WorkerActions o2) {
                return Double.valueOf(o2.mem).compareTo(o1.mem);
            }
        });
    }
    private void openServer(final int workers, final int epochs) {
        try {
            ...
            while (epochCounter < epochs) {
                ...
                System.out.println("Cost Function for epoch " + epochCounter + " : " + calculateError());
                System.out.println();
